...
func TestBinarySearch(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			result := search.BinarySearch(tt.arr, tt.target)
...
func TestBinarySearchRecursive(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			result := search.BinarySearchRecursive(tt.arr, tt.target, 0, right)
			if result != tt.expected {
...
func TestFindInsertPosition(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			result := search.FindInsertPosition(tt.arr, tt.target)
			if result != tt.expected {
...
func TestExampleCases(t *testing.T) {
	// Example 1
	arr1 := []int{1, 3, 5, 7, 9}
	if result := search.BinarySearch(arr1, 5); result != 2 {
		t.Errorf("Example 1: BinarySearch(%v, 5) = %d, expected 2", arr1, result)
	}

	// Example 2
	arr2 := []int{1, 3, 5, 7, 9}
	if result := search.BinarySearch(arr2, 6); result != -1 {
		t.Errorf("Example 2: BinarySearch(%v, 6) = %d, expected -1", arr2, result)
	}

	// Example 3
	arr3 := []int{1, 3, 5, 7, 9}
	if result := search.BinarySearchRecursive(arr3, 7, 0, len(arr3)-1); result != 3 {
	...
	// Example 4
	arr4 := []int{1, 3, 5, 7, 9}
	if result := search.FindInsertPosition(arr4, 6); result != 3 {
