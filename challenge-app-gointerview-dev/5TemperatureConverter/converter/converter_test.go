...
func TestRound(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			result := converter.Round(tt.value, tt.decimals)
...
func TestRoundTrip(t *testing.T) {
	...
	roundTrip := converter.FahrenheitToCelsius(converter.CelsiusToFahrenheit(originalCelsius))
	...
	roundTrip = converter.CelsiusToFahrenheit(converter.FahrenheitToCelsius(originalFahrenheit))
